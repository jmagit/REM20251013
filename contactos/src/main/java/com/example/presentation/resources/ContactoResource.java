...
public class ContactoResource {
	...
	public List<ContactoShort> getAll(@RequestParam(required = false, name="search") String fragmento) {
		return fragmento == null ? dao.findAllBy(ContactoShort.class) : dao.searchTop20ByNombreContainsIgnoreCaseOrderByNombreAsc(fragmento, ContactoShort.class);
	}

	@GetMapping(params = "_page")
	@Operation(summary = "Listar todos")
	public PagedModel<Contacto> getAll(
			...
			Pageable page) {
		return new PagedModel<Contacto>(fragmento == null ? dao.findAll(page) : dao.searchByNombreContainsIgnoreCaseOrderByNombreAsc(fragmento, page, Contacto.class));
	}
